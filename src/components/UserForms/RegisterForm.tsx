...
const UserRegisterFormSchema = z
    .object({
        ...
        password: z
            .string()
            .regex(/^[a-zA-Z0-9]*$/, 'Пароль должен быть латинскими буквами.')
            .min(8, 'Не менее восьми символов.'),
...
export const RegisterForm: FC = () => {
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<UserRegisterFormSchemaType>({
        ...
        <div className="login">
            ...
            >
                ...
                {registerMutation.error && (
                    <span className="login__error">Ошибка регистрации</span>
                )}
            </form>
        </div>
    );

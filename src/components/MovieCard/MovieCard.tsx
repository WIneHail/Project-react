...
import { translateCurrency, translateLanguageToFullname } from "../../utils/localTranslation";
...
export const MovieCard: FC<MovieProps> = ({ isRandom }) => {
  ...
  const favoriteState = useAppSelector((state) => state.fetchMe.user?.favorites)
    ...
    <div className="movie">
      <div className="movie__content content">
        <div className="content__top">
          <Rating isSmall={false} className='content__rating' rating={data.tmdbRating} />
      ...
      <img src={(data.backdropUrl ? data.backdropUrl : imageNotFound)} alt="movie-poster" className="movie__img" />
      {!isRandom &&
        <div className="movie__details details">
          ...
          <div className="detals__table table">
            <span className="table__row">
              ...
              <p className="table__content">{translateLanguageToFullname(data.language)}</p>
            </span>
            <span className="table__row">
              <div className="table__wrapper">
              ...
              <p className="table__content">{translateCurrency(data.budget)}</p>
            </span>
            <span className="table__row">
              <div className="table__wrapper">
              ...
              <p className="table__content">{translateCurrency(data.revenue)}</p>
            </span>
            <span className="table__row">
              <div className="table__wrapper">
              ...
              <p className="table__content">{data.director ? data.director : "Неизвестно"}</p>
            </span>
            <span className="table__row">
              <div className="table__wrapper">
              ...
              <p className="table__content">{data.production ? data.production : "Неизвестно"}</p>
            </span>
            <span className="table__row">
              <div className="table__wrapper">
              ...
              <p className="table__content">{data.awardsSummary ? data.awardsSummary : "Неизвестно"}</p>
            </span>
